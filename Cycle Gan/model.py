...
#
#         self.conv1 = layers.Conv2D(32, 7, 1,
#                                    kernel_initializer=tf.random_normal_initializer(stddev=0.02))
#         self.conv2 = layers.Conv2D(64, 3, 2, padding='same',
#                                    kernel_initializer=tf.random_normal_initializer(stddev=0.02))
#         self.conv3 = layers.Conv2D(128, 3, 2, padding='same',
#                                    kernel_initializer=tf.random_normal_initializer(stddev=0.02))
#
...
#
#         self.conv1 = layers.Conv2D(128, 3, 1,
#                                    kernel_initializer=tf.random_normal_initializer(stddev=0.02))
#         self.conv2 = layers.Conv2D(128, 3, 1,
#                                    kernel_initializer=tf.random_normal_initializer(stddev=0.02))
#
#         self.bn1 = layers.BatchNormalization()
#         self.bn2 = layers.BatchNormalization()
...
#
#         self.conv1 = layers.Conv2DTranspose(64, 3, 2, padding='same',
#                                             kernel_initializer=tf.random_normal_initializer(stddev=0.02))
#         self.conv2 = layers.Conv2DTranspose(32, 3, 2, padding='same',
#                                             kernel_initializer=tf.random_normal_initializer(stddev=0.02))
#         self.conv3 = layers.Conv2DTranspose(3, 7, 1,
#                                             kernel_initializer=tf.random_normal_initializer(stddev=0.02))
#
#         self.bn1 = layers.BatchNormalization()
#         self.bn2 = layers.BatchNormalization()
...
#
#         x = tf.nn.tanh(self.bn3(self.conv3(x)))
#
#         return x
#
...
#                                    kernel_initializer=tf.random_normal_initializer(stddev=0.02))
#         self.conv4 = layers.Conv2D(512, kernel_size=4, strides=1, padding='same',
#                                   kernel_initializer=tf.random_normal_initializer(stddev=0.02))
#         self.conv5 = layers.Conv2D(1, kernel_size=4, strides=1, padding='same',
#                                   kernel_initializer=tf.random_normal_initializer(stddev=0.02))
#
...
#
#
# def discriminator_loss(disc_of_real_out, disc_of_gen_out, lsgan=True):
#     if lsgan:
#
#         real_loss = tf.keras.losses.mean_squared_error(disc_of_real_out, tf.ones_like(disc_of_real_out))
#         gen_loss = tf.keras.losses.mean_squared_error(disc_of_gen_out, tf.zeros_like(disc_of_gen_out))
#
#         total_disc_loss = real_loss + gen_loss
#     else:
#         raise NotImplementedError
#
#         real_loss = tf.nn.sigmoid_cross_entropy_with_logits(tf.ones_like(disc_of_real_out), disc_of_real_out)
#
#         gen_loss = tf.nn.sigmoid_cross_entropy_with_logits(tf.zeros_like(disc_of_gen_out), disc_of_gen_out)
#
#         total_disc_loss = real_loss + gen_loss
#
#     return total_disc_loss
#
# def generator_loss(disc_of_gen_out, lsgan=True):
#     if lsgan:
#         gen_loss = tf.keras.losses.mean_squared_error(disc_of_gen_out, tf.ones_like(disc_of_gen_out))
#
#         total_disc_loss = gen_loss
#     else:
#         raise NotImplementedError
#
#         gen_loss = tf.nn.sigmoid_cross_entropy_with_logits(tf.ones_like(disc_of_gen_out), disc_of_gen_out)
#
#         total_disc_loss = gen_loss
#
#     return total_disc_loss
